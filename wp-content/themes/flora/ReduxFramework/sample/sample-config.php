<?php
   ...
   /* Redux::setSection( $opt_name, array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'desc'             => __( 'For Social Media Links', '' ),
        'id'               => 'basic-Text',
        'subsection'       => true,
...
*/
    ...
    Redux::setSection( $opt_name, array(
        'title'      => __( 'Footer Editor', 'redux-framework-demo' ),
        'id'         => 'editor-wordpress',
        //'icon'  => 'el el-home'
        'desc'       => __( 'Footer Copy right text', '' ),
        'subsection' => true,
        'fields'     => array(
            array(
                'id'       => 'opt-editor',
                ...
                'default'  => '@ Powered by Flora Fountaion.',
            ),
            /*array(
                'id'      => 'opt-editor-tiny',
                'type'    => 'editor',
