...
$portfolio_field = get_field('portfolio_field');

//Service Header Section 
$portfolio_header = $portfolio_field['portfolio_header'];
$portfolio_header_image_one = $portfolio_header['portfolio_header_image_one'];
$portfolio_header_image_second = $portfolio_header['portfolio_header_image_second'];
$portfolio_header_text = $portfolio_header['portfolio_header_text'];
$portfolio_header_content = $portfolio_header['portfolio_header_content'];
$portfolio_header_button_name = $portfolio_header['portfolio_header_button_name'];
$portfolio_header_button_link = $portfolio_header['portfolio_header_button_link'];
